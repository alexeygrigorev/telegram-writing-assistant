---
title: "Google Stitch: Design-First AI Development"
created: 2026-01-23
updated: 2026-01-23
tags: [google, gemini, design, ui, tools]
status: draft
---

# Google Stitch: Design-First AI Development

Google's Stitch is a new tool from Google Labs that may be better suited for design work than code-focused tools like Cursor.
...
This could be a "tools I tried" section where I test new tools and describe the results - whether good or not so good. This type of content could potentially be sponsored by tool vendors in the future[^2].
