---
title: "Designing Practical Online Courses"
created: 2026-03-05
updated: 2026-08-09
tags: [research, course-design, instructional-design, teaching, python, ai-engineering]
status: draft
---

# Designing Practical Online Courses

Research on designing programming and AI-engineering courses that lead students from explicit outcomes to a working project. It combines learning-science frameworks, a stage-gate design process, concrete completion-rate interventions, and a competitor-course case study.[^1]
...
Course quality is not only the quality of the material. The path through the material must make progress obvious and reduce the number of places where a student can get stuck. In one AI Buildcamp cohort, about 50 people enrolled, roughly 10 submitted the first homework, and only 5-6 graduated. That roughly 10% completion rate motivated a more guided design for the next cohort.[^2]

The central intervention is a single project that grows every week. Give students a template repository and tell them exactly where the next small piece belongs. This removes setup and architecture decisions while preserving the meaningful work of adapting the project to their own idea.[^2][^3]

### A Six-Week Guided Project

1. Project idea and repository: create a repository and explain the idea in its README.
2. Agents and tools: start from an implemented tool class and agent, then adapt the tools and instructions to the chosen use case.
3. Continue the agent implementation and document any tools that are not ready yet.
4. Tests: adapt a supplied unit test and an LLM-as-judge test to the project.
5. Logging: connect Logfire and verify that project activity produces traces.
6. Evaluation: connect an evaluation tool and assemble ten representative questions, written manually or generated with an LLM.[^3]

The reference project should be text-first rather than video-first so it stays easy to update and students can copy and adapt precise code. A deliberately simple example can run through the entire course; it is a working reference, not a second explanation of every concept.[^4]

Repeatedly distinguish required material from material that can wait. The useful rhythm is: watch the minimum relevant lesson, apply it immediately to the project, then complete the small homework. This keeps a large content library from becoming a content dump.[^2]

An AI assistant can help complete remaining project pieces near the end, provided the weekly code and documentation have been structured for it. The assistant should amplify accumulated progress, not replace the sequence of student practice.[^2]

### Instructional-Design Review

Before developing a new module, review it from the perspective of an experienced instructional designer focused on observable outcomes, curriculum sequencing, cognitive load, practice time, stuck-point prevention, and completion rates. Useful frameworks include ADDIE, Bloom's taxonomy, cognitive load theory, adult learning, retrieval practice, spaced learning, and just-in-time instruction. The key review question is: "What will students be able to do after this?"[^7][^9] This remains an area for deeper research as the course evolves.[^10]

Ask specifically about the narrative arc of a lecture or module, not only its topic coverage.[^8] Alex Migutsky recommended *Instructional Design That Soars* as a source for this review approach.[^5][^6] A useful practice-time target for live sessions is 40-50%, while every activity should connect to an outcome and assessment.

## Case Study: Agentic AI Engineering

The paid Agentic AI Engineering course by Towards AI and Decoding AI is a useful competitor example. It packages 34 lessons, 17 free Jupyter notebooks, and a complete multi-agent project into a self-paced course with certification.[^11]

Its progression illustrates several of the design principles above:

1. Foundations: structured output, workflow patterns, tools, ReAct, memory, knowledge access, and multimodality.
2. System design: project scoping, framework comparison, and architectural decisions.
3. Nova research agent: FastMCP tools, data ingestion, iterative research, and human-approved queries.
4. Brown writing workflow: evaluator-optimizer loops, MCP-based editing, context engineering, and course-lesson generation.
5. LLMOps and deployment: Opik observability, datasets and evaluation, CI, authentication, Docker, Cloud SQL, and Cloud Run.
6. Certification project: build an MCP server with agent patterns, evaluation, and observability.

The course's strongest structural choice is that two substantial agents provide continuity. Nova researches websites, repositories, and videos using Firecrawl, gitingest, Gemini, and Perplexity. Brown turns research into publishable content using LangGraph, multimodal generation, human feedback, and evaluator-optimizer loops. The projects give each technical lesson a destination.

The curriculum also makes its production standard explicit: notebooks teach concepts, but the intended outcome includes a real codebase, tests, observability, Docker, CI/CD, authentication, and deployment. That is constructive alignment when the promised skill is production AI engineering rather than notebook experimentation.

The 17 notebooks are freely available in the [course repository](https://github.com/towardsai/agentic-ai-engineering-course), making them useful references for structured outputs, tools, ReAct, memory, FastMCP, research loops, writing workflows, human feedback, evaluation, and CI. The [course page](https://academy.towardsai.net/courses/agent-engineering) shows how these pieces are packaged.
...
- The guided-project interventions are intended for the third AI Buildcamp cohort; measure where students drop out and revise the sequence after the pilot.
- The course case study is also relevant to the [AI-assisted writing](ai-assisted-writing.md) research because Nova and Brown form its research-and-writing pipeline.
...
[^2]: [20260218_115900_AlexeyDTC_msg1925_transcript.txt](../../inbox/used/20260218_115900_AlexeyDTC_msg1925_transcript.txt)
[^3]: [20260218_120056_AlexeyDTC_msg1926_transcript.txt](../../inbox/used/20260218_120056_AlexeyDTC_msg1926_transcript.txt)
[^4]: [20260218_120134_AlexeyDTC_msg1927_transcript.txt](../../inbox/used/20260218_120134_AlexeyDTC_msg1927_transcript.txt)
[^5]: [20260218_120220_AlexeyDTC_msg1928.md](../../inbox/used/20260218_120220_AlexeyDTC_msg1928.md)
[^6]: [20260218_120250_AlexeyDTC_msg1930_transcript.txt](../../inbox/used/20260218_120250_AlexeyDTC_msg1930_transcript.txt)
[^7]: [20260218_120220_AlexeyDTC_msg1929.md](../../inbox/used/20260218_120220_AlexeyDTC_msg1929.md)
[^8]: [20260218_120318_AlexeyDTC_msg1931.md](../../inbox/used/20260218_120318_AlexeyDTC_msg1931.md) and [20260218_120337_AlexeyDTC_msg1932.md](../../inbox/used/20260218_120337_AlexeyDTC_msg1932.md)
[^9]: [20260218_120401_AlexeyDTC_msg1933_transcript.txt](../../inbox/used/20260218_120401_AlexeyDTC_msg1933_transcript.txt)
[^10]: [20260218_120622_AlexeyDTC_msg1934_transcript.txt](../../inbox/used/20260218_120622_AlexeyDTC_msg1934_transcript.txt)
[^11]: [20260312_173801_AlexeyDTC_msg2884.md](../../inbox/used/20260312_173801_AlexeyDTC_msg2884.md)
