---
title: "AI-Assisted Writing: Research, Drafting, Evaluation, and Branded Diagrams"
created: 2026-04-24
updated: 2026-08-09
...
# AI-Assisted Writing: Research, Drafting, Evaluation, and Branded Diagrams
...
The course page mentions 34 lessons, three end-to-end portfolio projects, a certificate, and a Discord community. The first six lessons are free. See the [course-design case study](course-design.md#case-study-agentic-ai-engineering) for the broader curriculum breakdown.
...
The telegram-writing-assistant project already produces Mermaid diagrams inside research articles. Today those diagrams render with the default Mermaid theme. The branded-image step Paul describes is the piece you could bolt on top.
...
- [Designing Practical Online Courses](course-design.md#case-study-agentic-ai-engineering) covers the broader paid-course context and how Nova and Brown give its curriculum a continuous project.
- [AI Course Generation with Claude Skills](ai-course-generation-skill.md) examines a different template-first approach to producing educational content.
- [Marketing and Content](../ai-shipping-labs/marketing-and-content.md#inspiration-paul-iusztins-decoding-ai-newsletter) separates the marketing lesson in Paul's inline course promotion from the technical pipeline documented here.
