...
|-------|--------|--------------|-------------|
| [Substack Archive Index](_substack-archive-index.md) | draft | 2026-09-04 | Lookup table of all published Substack posts (title, description, URL), used to insert direct links to things Alexey has already shared |
