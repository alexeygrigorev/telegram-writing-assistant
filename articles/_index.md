...
| Title | Status | Last Updated | Description |
|-------|--------|--------------|-------------|
| [AI Engineering Buildcamp Cohort 2 - Demo Day](demo-day-cohort-2.md) | draft | 2026-04-24 | Capstone projects from Cohort 2 demo: Edu's bikepacking recommender, Pablo's family meal-map, Camila's engineering decision memory agent, Ladden's voice-to-issue Telegram bot, Spiros' offline medical SOAP notes; plus submitted-but-not-presented projects from Nirajan (Cyber Sachet/Nepal), Juan Prim (AMR), and LEMTideman (AI regulation assistant) |
