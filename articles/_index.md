...
|-------|--------|--------------|-------------|
| [Generating Books with AI](ready-for-newsletter/ai-book-generator.md) | draft | 2026-05-07 | Backstory: child's specific-topic requests (metals, gallium-kalium alloys, conifers), iterating from ChatGPT-only to Copilot+GitHub-issues to a custom plan-then-execute Gemini agent; how the generator works (Streamlit chat, YAML plan, chapter loop, Pandoc/XeLaTeX/ReportLab publishing, Gemini TTS, Makefile); $5/book, Amazon KDP experiment selling 0 copies in 5 months |
...
| Title | Status | Last Updated | Description |
|-------|--------|--------------|-------------|
| [Personalised Plans](ai-shipping-labs/plans/_index.md) | draft | 2026-05-07 | Daniel Sa Earp's plan updated with notes from his 2026-05-07 intake call with Valeriia (sprint reception, coding approach, AI Hero access, long-term guidance question, future course suggestion) plus his side project idea (chatbot platform for his wife's audiovisual education business). Three new plans (Manjunath Yelipeta - traditional ML engineer pivoting to AI/AI Platform, ship deployed RAG with evaluation; Daniel Sa Earp - Brazilian analytics engineer prepping for June LLM Zoomcamp, build GitHub-issues ingestion pipeline; Valeriia Kuka - non-programmer team member, complete AI Hero) and Luca's plan updated with structured Q&A from his intake doc + follow-up notes (20 hr/week, framework leaning is pydantic-ai or smolagents) |
...
| Title | Status | Last Updated | Description |
|-------|--------|--------------|-------------|
| [Weekly Log](weekly-log.md) | draft | 2026-05-08 | Extended Week of 2026-05-04 with the freestyle AI Shipping Labs workshop on AWS Lambda deployment (motivation: Render-style services aren't truly serverless), AI Shipping Labs site migration from Next.js to Django (now live at aishippinglabs.com), May sprint kickoff with 20+ member plans and the idea to pair people up, and the DataTalks.Club migration to Rustkill (Jekyll-shaped, much faster build). Also folded msg3946's Porto re-narration into the existing Data Makers Fest paragraphs |
