...
| Title | Status | Last Updated | Description |
|-------|--------|--------------|-------------|
| [Personalised Plans](ai-shipping-labs/plans/_index.md) | draft | 2026-05-08 | Two new plans added on 2026-05-08: Aashiesh Siwach (ML engineer transitioning to production-ready AI Engineer; intake collected via Google Doc, initial input only - the 10 follow-up questions remain unanswered) and Juan Perez Prim (Madrid-based data science lead from Alexey's Maven AI Engineering Buildcamp, 5-10 hr/week; sprint priority is deploying his amr_ai Streamlit learning agent on Antibiotic Resistance to a secure independent website). Both intakes are awaiting Alexey's recommendations. Daniel Sa Earp's plan updated with notes from his 2026-05-07 intake call with Valeriia plus his side project idea. Three earlier plans (Manjunath Yelipeta, Daniel Sa Earp, Valeriia Kuka) and Luca's plan also updated recently |
