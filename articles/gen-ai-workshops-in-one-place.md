---
title: "All my Gen.AI Workshops are Now in One Place"
created: 2026-05-11
updated: 2026-05-11
tags: [ai-shipping-labs, workshops, announcement, newsletter]
status: draft
---
...
The list at [aishippinglabs.com/workshops](https://aishippinglabs.com/workshops) currently includes[^3]:

- Deploying an Agent to AWS Lambda (May 2026) - takes the FastAPI service from the previous workshop, strips FastAPI, and swaps in a custom AWS Lambda runtime
- End-to-End Agent Deployment (Apr 2026) - turns a Jupyter agentic-RAG bot into a FastAPI service with a vanilla-JS frontend, containerizes it, and deploys it
- Skills.md from Scratch: Build a Skill-Driven Coding Agent (Jan 2026) - extends a basic coding agent into a general-purpose one using skills and commands
- Building Safe AI Agents with Guardrails (Jan 2026) - adds topic checks and unsafe-response blocking to a course FAQ assistant
- Build a Production-Ready YouTube AI Agent with Temporal (Dec 2025) - deep-research agent over the DataTalks.Club podcast archive, with Temporal for orchestration
- Building AI Agents with MCP, PydanticAI and OpenAI (Sep 2025) - builds a course FAQ assistant from a plain search() function up to OpenAI Responses API, then PydanticAI and MCP
- Building a Coding Agent: Python/Django Edition (Aug 2025) - a Django project bootstrapper that scaffolds an app from a plain-language request
- AI Coding Tools Compared (Jul 2025) - ChatGPT, Claude, Copilot, Cursor, Lovable, and AI agents each asked to help build Snake in React
...
[^1]: [20260511_074249_AlexeyDTC_msg4012_transcript.txt](../inbox/used/20260511_074249_AlexeyDTC_msg4012_transcript.txt)
[^2]: [20260511_074407_AlexeyDTC_msg4014_transcript.txt](../inbox/used/20260511_074407_AlexeyDTC_msg4014_transcript.txt)
[^3]: [20260511_074439_AlexeyDTC_msg4016.md](../inbox/used/20260511_074439_AlexeyDTC_msg4016.md)
[^4]: [20260511_074234_AlexeyDTC_msg4009_transcript.txt](../inbox/used/20260511_074234_AlexeyDTC_msg4009_transcript.txt)
