...
- Run each candidate idea through the project fit-check prompt below. Pick one - ideally a problem he wants solved, with data he already has or can get easily.
...
- Keep scope narrow enough that the first version runs by end of week.
- Continue AI Hero.
...
After AI Hero, the natural next step is LLM Zoomcamp (re-recorded version starting in June, with five workshops mapped to the modules). Plan to bring a project into LLM Zoomcamp that you want to ship - the course homework arc is much easier to complete when it is producing something you care about. The 6-week sprint project here can become the LLM Zoomcamp project too if it is sized right.
...
> Hi Valeriia,
>
> Thanks for the warm welcome. I am excited to join the community.
>
...
- Self-described as "interested" in AI engineering after the climate RAG work.
