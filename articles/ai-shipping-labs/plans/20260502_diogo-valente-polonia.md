...
- Supporting focus: deploy the agent so it is usable at work. The deliverable is "a tool I'm actively using now at work", not a notebook.
...
- Deploy a first version. Streamlit Community Cloud, a small VM, an internal app inside the EEA stack - whatever lets you use the tool at work. The goal is "Diogo opens the tool during his actual workflow", not a public launch.
...
- Deployment is part of building. The 10 hours per week budget includes deployment - the tool is not "done" until Diogo is using it at work.
