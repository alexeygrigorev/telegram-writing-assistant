...
- Do the final-project module / capstone. Pick a topic that is small enough to finish in the remaining time. The DataTalks.Club podcast Q&A is one option, but anything from the course's suggested projects is fine.
...
She has automation ideas for DataTalks.Club content but feels she does not have the engineering knowledge to implement them. In parallel she is working on a content audit for DataTalks.Club - that is the marketing/professional thread, separate from this plan[^1].
...
[^3]: [20260506_200709_AlexeyDTC_msg3886_transcript.txt](../../../inbox/used/20260506_200709_AlexeyDTC_msg3886_transcript.txt) - Alexey's recommendations for Valeriia's plan.
