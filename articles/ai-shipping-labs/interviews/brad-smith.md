...
# Interview: Brad Smith

## Persona

Alex - the engineer transitioning to AI. Brad wants to develop portfolio projects that are interesting to potential employers and apply AI engineering findings to his current role. His main difficulty is building apps with a consistent tech stack (deployment, getting data into usable forms) rather than AI-specific concepts, which fits Alex's "engineering skills present, AI-specific and integration gap" profile.
