...
user_id: 822266080
username: AlexeyDTC
original_filename: vibezoom.md
---
# Product Shipping Zoomcamp

## Working title

**End-to-End Product Development Zoomcamp**

Alternative names:

- **Build & Ship Zoomcamp**
- **Product Shipping Zoomcamp**
- **Vibe Shipping Zoomcamp**
- **Full-Stack Product Zoomcamp**
- **Build in Public Zoomcamp**

Recommended name:

## **Product Shipping Zoomcamp**

It is broad enough to include any product, while still making it clear that the goal is not only coding. The course is about building, deploying, improving, measuring, and launching a real product.
...
> “I shipped a deployed product, got feedback, improved it, measured usage, launched it publicly, and reviewed other students’ products.”
...
This follows the same spirit as the Vibe Shipping idea:

> **Product = Code + Marketing + Sales**

Students should not treat marketing and users as something that happens only after development is finished.
...
**A product is not finished when the code works. A product exists when other people can use it.**
...
The course should avoid the common trap:

> “I spent six weeks coding, then I launched to nobody.”

Instead, students start building public presence and community context from the first module.
...
The structure mirrors the ML Zoomcamp style:

- students complete modules independently
- they submit a project
- they evaluate three peer projects
- project submission and peer-evaluation windows are separate
- peer review is required for the project to count
...
By the time students launch, they should already have:

- joined relevant communities
- observed what people talk about
- posted progress
- asked questions
- shared early lessons
- found potential testers
- built some familiarity with the target audience

The launch should not be the first time anybody hears about the product.
...
## Channels students may use

Students should choose channels based on their target audience:
...
- niche forums
- newsletters
- university or local communities
- direct outreach

The important lesson:

> Do not launch everywhere. Launch where your users already spend time.

## Required build-in-public tracker
...
Find a real problem, define a focused MVP, and start building public context around the idea.

This module should be mostly about discovery, not coding.

Students should not start with:

> “I want to build an app.”

They should start with:

> “Who is this for, what job are they trying to do, where do they already talk about this, and what is the smallest product that can test the idea?”

## Main question

**What problem or job are we building for, and where do these people already hang out?**

## Topics

### 1. Jobs To Be Done

Students learn to frame the product around a user job.
...
### 2. Problem and idea discovery

Students research before building.
...
- confusing existing solutions
- people paying for bad solutions
- communities where the problem appears often

### 3. Community mapping

Students identify where their users already are.
...
### 4. Build-in-public setup

Students choose one or more channels where they will share progress.

They define:

- where they will post
- what kind of posts they will make
- how often they will post
- what communities they will observe
- what communities they may eventually launch to

### 5. MVP scope

Students define the smallest useful product.
...
By the end of Module 1, students submit:
...
Build and deploy the thinnest possible full-stack product.

This module can be inspired by the **Full-Stack Vibe Coding** workshop:

https://aishippinglabs.com/workshops/full-stack-vibe-coding

The workshop builds a full-stack app end to end with a coding assistant, including:
...
**Can we deploy a thin end-to-end slice that proves the product architecture works?**

## Focus

This module is not about polish.  
This module is not about launch.  
This module is not about perfect UX.

The goal is:

> A deployed full-stack skeleton where the core flow works online.
...
- Basic tests or smoke tests
- Docker or container setup, if appropriate
- Basic CI/CD
...
The running example can be a small web game.

For example:

- frontend: game UI
- backend: game/session API
- persistence: users/scores/sessions
- deployed URL: playable online version
- CI/CD: deploy on push
- README: how to run and test

But students can apply the same structure to other products.

## Deliverables

By the end of Module 2, students submit:
...
- basic smoke test or health check

## Build-in-public assignment

Students share:

- what they are building
- the first deployed version or technical milestone
- what worked
- what was harder than expected
- what they plan to make usable next
...
Turn the deployed thin slice into a minimal usable version with clear focus.
...
> Can another person understand and use it?

## Main question

**Can a peer reviewer open the deployed product, test the core flow, and give useful feedback?**

## Topics

### 1. Scope tightening

Students reduce ambiguity.

- remove unfinished features
- hide broken sections
- remove placeholder pages
- focus on one main flow
- document known limitations
- avoid adding random features before the midterm

### 2. First-use clarity

Students improve the first 30 seconds.

- clear homepage or start screen
- simple explanation
- one primary CTA
- empty states
- success states
...
Students make the main path reliable.
...
- improve forms
- make buttons clear
- ensure fresh users can complete the flow
- make sure deployed version matches README

### 4. Free reviewer access

If the application has login, payment, credits, subscriptions, API limits, or gated features, the student must provide a free testing path.
...
- Stripe test mode
- seeded demo user
- temporary unlocked reviewer mode
- bypass flag for reviewers
...
- feedback form
- bug report link
- one question after the main flow
- 1–3 specific questions for reviewers

Full analytics comes later in Module 5.

### 6. Review-ready documentation
...
- main flow reviewers should try
- known limitations
- what feedback the student wants

## Deliverables

By the end of Module 3, students submit:
...
- commit hash for midterm submission
...
- what the MVP does
- who it is for
- what kind of testers they need
- the deployed link, if appropriate
...
The midterm is the first formal interaction point.

Students submit a deployed MVP and review 3 peer projects.

The goal is not a polished final product. The goal is:

> Can another person open the application, understand it, test it for free, complete the core flow, and give useful feedback?
...
- MVP scope
- free testing instructions
- setup/run instructions, if local testing is possible
- known limitations
- feedback form or feedback link
- 1–3 reviewer questions

## Midterm peer review requirement

Each student must review **3 peer projects**.

For each project, the reviewer should:

- open the deployed application
- test it without paying
- try the main user flow
- read the README
...
Use midterm peer feedback to improve the product.

This module is about disciplined iteration, not adding random features.

## Main question

**Did students turn feedback into better product decisions?**

## Topics

### 1. Feedback synthesis

Students collect all feedback from:

- peer reviews
- external testers
- community comments
- build-in-public responses
- their own observations

They group feedback into:
...
Students decide what to fix now.

They classify work as:
...
Students improve the core product.
...
- update copy
- improve layout
- adjust pricing/free access, if relevant
- improve landing page clarity
- update README
- update reviewer/tester instructions

### 4. Changelog

Students document what changed since the midterm.
...
By the end of Module 4, students submit:

- improved deployed application
- feedback synthesis
- prioritized issue list
- post-midterm changelog
- updated README
- updated build-in-public post

## Build-in-public assignment

Students share a “feedback to product decision” post.
...
Make the product measurable and safer to expose to more users.

Persistence and basic state already belong in Module 2. Module 5 should not be “data and state.” Instead, it should focus on analytics, monitoring, and launch readiness.

## Main question

**When users arrive, will we know what happened?**

## Topics

### 1. Product analytics

Students define the key funnel for their product.

Example funnel:

1. user opens app
2. user starts core flow
3. user completes core flow
4. user submits feedback / signs up / shares / returns

They add events such as:
...
- feedback_submitted
- share_clicked
- payment_started, if relevant
- upgrade_clicked, if relevant
...
Students define the product’s activation moment.
...
> What action means the user actually experienced the value of the product?
...
- how many complete the main flow
- where people leave
- what errors occur
- what should be fixed before launch

### 4. Qualitative feedback loop

Students connect analytics with human feedback.
...
- bug report link
- post-flow question
- “Was this useful?” prompt
- contact link

### 5. Monitoring and error visibility

This is not CI/CD. CI/CD already happens in Module 2.

Module 5 is about knowing what happens after deployment.

Students add basic visibility:

- error logging
- frontend error tracking, if possible
- backend logs
- health endpoint
- uptime check
- basic monitoring dashboard
- simple alerting, if practical

The goal is:

> If the app breaks during launch, will the student notice?
...
- free testing path works
- core flow works on a fresh account/session
- main events are tracked
- feedback can be submitted
- errors are visible somewhere
- README is up to date
- landing page has a clear CTA
- known limitations are documented
- launch channels are selected
- build-in-public audience has been warmed up

## Deliverables

By the end of Module 5, students submit:

- analytics events list
- activation metric
- basic analytics view or event table
- feedback mechanism
...
Students share a learning post based on usage or readiness.
...
Launch to the audience and communities students have been building since Module 1.

Module 6 should not be the first time students think about launch. It is the moment where earlier community research, build-in-public posts, tester conversations, and product iteration come together.

## Main question

**Can students get the product in front of the right people and learn from the launch?**

## Topics

### 1. Positioning refresh

Students update their message based on what they learned.
...
- “how it works”
- target user
- free access instructions, if relevant
- social proof or early feedback, if available

### 3. Launch channel selection

Students choose channels based on the community work from Module 1.

They should not blindly post everywhere.

They prepare a launch plan:
...
- community-specific post
- follow-up message
- comment response templates

### 5. Launch

Students launch publicly or semi-publicly.

Possible launch actions:

- post in target community
- direct outreach to users
- post on LinkedIn/X
- post in a relevant Discord/Slack
- submit to Product Hunt
- post on Indie Hackers
- share on Hacker News
- publish to itch.io, if relevant
- write a launch blog post

### 6. Post-launch response

Students respond to what happens.
...
By the end of Module 6, students submit:

- final landing page
- launch copy
- selected launch channels
- launch evidence
- launch metrics
...
The final project is the second formal peer-review point.

The midterm asks:

> Is there a deployed MVP that others can test?

The final asks:

> Did this become an end-to-end product that was improved, measured, launched, and explained clearly?
...
- commit hash
- deployed application URL
- free testing instructions, if needed
- README
- landing page
- launch evidence
- analytics/metrics summary
- feedback summary
- changelog since midterm
- build-in-public summary
- final reflection
- future roadmap

## Final peer review requirement

Each student reviews **3 final projects**.
...
- verify free access
- inspect the README
- try the core user flow
- review the launch materials
- review the analytics/metrics summary
- review changes since midterm
...
- real users beyond classmates
- strong external feedback
- meaningful usage metrics
- signups, waitlist, revenue, or other conversion
- strong community engagement
- clear response to analytics
- polished launch post
- thoughtful roadmap
...
## Option A: 6 modules + midterm + final
...
## Discover → Build → Polish → Review → Improve → Measure → Launch → Review
