---
title: "AI-Native Development: Specifications, Loop and Graph Engineering"
date: 2026-07-22
url: https://aishippingblog.com/p/ai-native-development-specifications
---

This is the first article in a series based on [AI Dev Tools Zoomcamp](https://github.com/DataTalksClub/ai-dev-tools-zoomcamp), the free course we run at DataTalks.Club.

I start with AI-native developer workflows: how to turn an idea into a specification, give coding agents the right context, and verify what they build.

* Part 1: [AI-Native Development: Specifications, Loop and Graph Engineering](https://alexeyondata.substack.com/p/ai-native-development-specifications) (this article)
...
You can see the final result in the [retroloop repository](https://github.com/alexeygrigorev/retroloop).
...
[![The one-shot weekly-feedback CLI](https://substackcdn.com/image/fetch/$s_!Mvpa!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa9b81861-8ce0-4ecf-9a9a-1871d756760d_2352x812.png)](https://substackcdn.com/image/fetch/$s_!Mvpa!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa9b81861-8ce0-4ecf-9a9a-1871d756760d_2352x812.png)
...
You can find the [plan.md file](https://github.com/alexeygrigorev/retroloop/blob/711c33cc5b6b/_docs/plan.md) from this project in the Retroloop repository.
...
[![The goal prompts the agent to continue](https://substackcdn.com/image/fetch/$s_!E16L!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe542ff1c-b76c-4277-83a9-e284e952656f_1588x708.png)](https://substackcdn.com/image/fetch/$s_!E16L!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe542ff1c-b76c-4277-83a9-e284e952656f_1588x708.png)
...
In June 2026, Addy Osmani published the [Loop Engineering essay](https://addyo.substack.com/p/loop-engineering) that gave it a name, and Peter Steinberger compressed the idea into one tweet:

[![X avatar for @steipete](https://substackcdn.com/image/fetch/$s_!fakz!,w_40,h_40,c_fill,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fpbs.substack.com%2Fprofile_images%2F1131851609774985216%2FOcsssQ9J.png)
...
6:58 PM · Jun 7, 2026 · 8.49M Views

1.8K Replies · 1.41K Reposts · 19.9K Likes](https://x.com/steipete/status/2063697162748260627)
...
[![01-agent-workflow-styled.png](https://substackcdn.com/image/fetch/$s_!lxKR!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F525257ec-6465-4bad-a749-099a4557eba0_1440x360.png)](https://substackcdn.com/image/fetch/$s_!lxKR!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F525257ec-6465-4bad-a749-099a4557eba0_1440x360.png)
...
Peter Steinberger sparked a wider discussion in a [July 18 post](https://x.com/steipete/status/2078277297791189132) by asking whether the conversation had shifted from loops to graphs. A few hours later, Hamel Husain used [“graph engineering”](https://x.com/HamelHusain/article/2078346425621237935) in an article headline.

[![Image 5](https://substackcdn.com/image/fetch/$s_!Zzut!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8caa78d3-a47c-42ca-9a55-e042601bcc24_997x616.png)](https://substackcdn.com/image/fetch/$s_!Zzut!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8caa78d3-a47c-42ca-9a55-e042601bcc24_997x616.png)
...
I’ve followed this approach on many projects, including the [AI Shipping Labs website](https://aishippinglabs.com/).

I describe it in [I Built an AI Agent Team for Software Development](https://alexeyondata.substack.com/p/i-built-an-ai-agent-team-for-software). Here, I distill that article into a tutorial.
...
* Building and shipping a full-stack app end to end: spec to frontend, backend, tests, Docker, deployment and CI/CD
* Coding agent capabilities: MCP, skills, plugins, hooks and custom agents
* AI for security, audit and DevOps
* Taking a project of your own from an empty folder to something running
